...
<div class="text-uppercase"><h4>Capacity</h4><span class="selected-count"></span>
<span class="hide-border"></span>
</div>
<form id="search_form">

<div>
<label class="filter_"><input type="radio" name="cap" class="sort_rang" value="1"/>Less than 1000</label></div>
<div>
<label class="filter_"><input type="radio" name="cap" class="sort_rang" value="2"/>1000-2000</label></div>
<div>
<label class="filter_"><input type="radio" name="cap" class="sort_rang" value="3"/>More than 2000</label></div>

<hr/>
<div class="h6 text-uppercase"><h4>Price</h4><span class="selected-count"></span>
<span class="hide-border"></span>
</div>

<div>
<label class="filter_"><input type="radio" name="pri" class="sort_rang" value="1"/>5000-7000</label></div>
<div>
<label class="filter_"><input type="radio" name="pri" class="sort_rang" value="2"/>7001-10000</label></div>
<div>
<label class="filter_"><input type="radio" name="pri" class="sort_rang" value="3"/>More than 10000</label></div>

<hr/>
<div class="h6 text-uppercase"><h4>Type</h4><span class="selected-count"></span>
<span class="hide-border"></span>
</div>

<div>
<label class="filter_"><input type="radio" name="ac" class="sort_rang" value="1"/>AC</label></div>
<div>
<label class="filter_"><input type="radio" name="ac" class="sort_rang" value="0"/>Non-AC</label></div>
...
<?php echo '<a href="hall_desc.php?id='.$row['ID'].'&uid='.$uid.'" >';?><div class="container1" style="margin:4px">
