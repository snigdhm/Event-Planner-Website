...
$(document).on('change','.sort_rang',function(){
   var url = "ajax_search_decorator.php";
   $.ajax({
     type: "POST",
     url: url,
...
$query="SELECT decorator_.ID, decorator_.Name, decorator_.State, deco_pic.Picture FROM decorator_ INNER JOIN deco_pic ON decorator_.ID = deco_pic.ID WHERE deco_pic.pic_no=1";
...
<div class="text-uppercase"><h4>Decors</h4><span class="selected-count"></span>
<span class="hide-border"></span>
</div>
<form id="search_form">

<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Lighting"/>Lighting</label></div>
<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Chair covers"/>Chair covers</label></div>
<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Entrance features"/>Entrance features</label></div>
<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Flowers"/>Flowers</label></div>
...
<?php echo '<a href="deco_desc.php?id='.$row['ID'].'&uid='.$uid.'" >';?><div class="container1" style="margin:4px">
