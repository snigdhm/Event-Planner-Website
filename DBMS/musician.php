...
$(document).on('change','.sort_rang',function(){
   var url = "ajax_search_musician.php";
   $.ajax({
     type: "POST",
     url: url,
...
<div class="text-uppercase"><h4>Band</h4><span class="selected-count"></span>
<span class="hide-border"></span>
</div>
<form id="search_form">

<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Rock n Roll"/>Rock n Roll</label></div>
<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Folk"/>Folk</label></div>
<div>
<label class="filter_"><input type="checkbox" name="dec[]" class="sort_rang" value="Jazz"/>Jazz</label></div>
...
<?php echo '<a href="musician_desc.php?id='.$row['ID'].'&uid='.$uid.'" >';?><div class="container1" style="margin:4px">
