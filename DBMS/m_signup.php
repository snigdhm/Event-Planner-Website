...
<?php
   ...
   $db = mysqli_connect('localhost', 'root', 'root','test');
	  ...
	  $q1="INSERT INTO musician_ (Name,Address,State,Pincode,Price,Type,Description) VALUES ('".$sname."','".$address."','".$state."',".$pin.",".$price.",'".$band."','".$description."')";
      $r1= mysqli_query($db,$q1); 
	  $q2="SELECT ID FROM musician_ WHERE Name='".$sname."'";
	  $r2= mysqli_query($db,$q2);
	  $row = mysqli_fetch_array($r2);  
	  $q3="INSERT INTO login VALUES (".$row['ID'].",'".$myusername."','".$mypassword."','MU')";
	  $r3= mysqli_query($db,$q3); 
	  if($ph1)
	  {
		  $q4="INSERT INTO musician_phone VALUES (".$row['ID'].",".$ph1.")";
		  $r4= mysqli_query($db,$q4);
	  } 
      if($ph2)
	  {
		  $q4="INSERT INTO musician_phone VALUES (".$row['ID'].",".$ph2.")";
		  $r4= mysqli_query($db,$q4);
	  } 
	   $picno=1;
	  if($image1)
	  {
	  	$insert_image1="INSERT INTO musician_pic VALUES(".$row['ID'].",?,".$picno.")";
	   ...
	   if($image2)
	  {
	  	...
	  	$insert_image2="INSERT INTO musician_pic VALUES(".$row['ID'].",?,".$picno.")";
	   ...
	   if($image3)
	  {
	  	$insert_image3="INSERT INTO musician_pic VALUES(".$row['ID'].",?,".$picno.")";
